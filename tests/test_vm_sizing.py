...
def _base_input(**kwargs):
    defaults = dict(
        total_data_tb=100.0, annual_growth_percent=10.0, daily_change_percent=5.0,
        backup_type="synthetic_full_weekly", primary_retention_days=30,
        gfs_weekly_count=4, gfs_monthly_count=12, gfs_yearly_count=3,
        backup_window_hours=8.0, target_rpo_hours=24.0,
    )
...
def test_gfs_adds_to_total():
    no_gfs = size_repository(_base_input(gfs_weekly_count=0, gfs_monthly_count=0, gfs_yearly_count=0))
